...
Your visualization should be accompanies by a brief paragraph describing the choices you made in your improvement, specifically discussing what you didn't like in the original plots and why, and how you addressed them in the visualization you created.

- **You can download the template for the report** <a href="/assets/data/w2/Template.Rmd" class="btn btn--primary" download>Link Text</a>
...
produced based off the data given on the Wikipedia page.
    ...
    + You can download the orginal data <a href="/assets/data/w2/Fishing_industry_by_country.xlsx" class="btn btn--primary" download>Link Text</a>
...
<img width="100%" src="{{ site.baseurl | append:page.image-path | append: 'inst_staff.png' }}">
   ...
   + Download the orgininal data  <a href="/assets/data/w2/InstructionalStaffEmployTrends.xlsx" class="btn btn--primary" download>Link Text</a>
