...
- **You can download the template for the report** <a href="/assets/data/w2/Template.Rmd" class="btn btn--primary" download>Link</a>
...
produced based on the data given on the Wikipedia page.
   ...
   + You can download the orginal data <a href="/assets/data/w2/Fishing_industry_by_country.xlsx" class="btn btn--primary" download="Fishing_industry_by_country.xlsx">Link</a>
...
<img width="100%" src="{{ site.baseurl | append:page.image-path | append: 'inst_staff.png' }}">
   ...
   + Download the orgininal data  <a href="/assets/data/w2/InstructionalStaffEmployTrends.xlsx" class="btn btn--primary" download>Link</a>
