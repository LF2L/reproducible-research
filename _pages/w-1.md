...
## 2. [Understand the defaults interfaces of Rstudio](https://bookdown.org/ndphillips/YaRrr/the-four-rstudio-windows.html)
  ...
  + Source: It is here were we will create our article and 
...
If you understand four panels, continue to **[Understand the Basics](/workshop-2/)**. 
{: .notice--success}
...
- Go to `Save` buttonn and save the created document as `Intro-Reproducible-Research`
...
- Change the `Title` of document to `First reproducible document`
...
If you have the **first document reproducible** document,, continue to **[Understand the Basics](/workshop-2/)**. 
{: .notice--success}
